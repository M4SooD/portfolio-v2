...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-8 top-8 transition-opacity outline-none focus:outline-none disabled:pointer-events-none data-[state=open]:bg-secondary">
